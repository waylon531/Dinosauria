...
physics::Capsule::Capsule(std::shared_ptr<graphics::Mesh> mesh, const glm::vec3& pos, const float mass)
{
}

physics::Capsule::Capsule(std::shared_ptr<graphics::SkeletalMesh> mesh, const glm::vec3& pos, const float mass)
{
